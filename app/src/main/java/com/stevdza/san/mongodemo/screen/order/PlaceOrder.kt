...
fun PLaceOrder(
    ...
    val orderVm: OrderVm = viewModel()
    val bookListVm: PriceVM = viewModel()
    val customerListVm: CustomerVM = viewModel()
    ...
    if (accessKeyCheck == inputAccessKey) {
        Scaffold(
            ...
            content = {
                ...
                val bookProducedVm: BookRecordVM = viewModel()
...
fun AddOrderDetails(
    ...
    Card(modifier = Modifier
        ...
        Row(
            ...
            Text(modifier = Modifier.weight(4.5f),text = orderDetails.bookName, style = button.copy(fontSize = 15.sp), color = DarkBlue)
